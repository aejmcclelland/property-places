...
function SubmitMessageButton() {
    ...
    return (
        <button
            className='bg-red-500 hover:bg-red-300 text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline flex items-center justify-center'
            type='submit'
        >
